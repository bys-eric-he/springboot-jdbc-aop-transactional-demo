package com.springboot.jdbc.demo.aop;

import com.springboot.jdbc.demo.aop.annotation.AopTransaction;
import com.springboot.jdbc.demo.aop.transaction.TransactionUtil;
...
public class AopTransactionService {
     ...
     */
    @Pointcut("execution(public * com.springboot.jdbc.demo.service..*.*(..))")
